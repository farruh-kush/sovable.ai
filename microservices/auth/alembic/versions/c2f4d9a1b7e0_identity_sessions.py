...
down_revision: Union[str, Sequence[str], None] = "a107c58d06ea"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_table(
        "user_identities",
        sa.Column("id", sa.String(length=64), primary_key=True),
        sa.Column("user_id", sa.String(length=64), sa.ForeignKey("user_accounts.id", ondelete="CASCADE"), nullable=False),
    ...
    op.create_index("ix_verification_challenges_destination_hash", "verification_challenges", ["destination_hash"])
    op.create_table(
        "auth_sessions",
        sa.Column("id", sa.String(length=64), primary_key=True),
        sa.Column("user_id", sa.String(length=64), sa.ForeignKey("user_accounts.id", ondelete="CASCADE"), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index("ix_verification_challenges_destination_hash", table_name="verification_challenges")
