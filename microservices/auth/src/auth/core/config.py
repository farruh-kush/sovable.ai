...
class AuthSettings(BaseSettings):
    ...
    database_url: str = Field(default="postgresql+asyncpg://postgres:postgres@postgres:5432/auth_db", alias="DATABASE_URL")
    ...
    directmail_endpoint: str = Field(default="dm.ap-southeast-1.aliyuncs.com", alias="DIRECTMAIL_ENDPOINT")
